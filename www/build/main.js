...
var TabsPage = /** @class */ (function () {
    ...
    TabsPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-tabs',template:/*ion-inline-start:"C:\Users\admin\Desktop\bookCd-master\src\pages\tabs\tabs.html"*/'<ion-tabs>\n  <ion-tab [root]="LivrePage" tabTitle="Livre" tabIcon="bookmarks"></ion-tab>\n  <ion-tab [root]="unicCdPage" tabTitle="CD" tabIcon="disc"></ion-tab>\n</ion-tabs>\n'/*ion-inline-end:"C:\Users\admin\Desktop\bookCd-master\src\pages\tabs\tabs.html"*/
        })
    ], TabsPage);
    return TabsPage;
}());
...
var ListCdPage = /** @class */ (function () {
    ...
    ListCdPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-unicCD',template:/*ion-inline-start:"C:\Users\admin\Desktop\bookCd-master\src\pages\cd\cd.html"*/'<ion-header>\n  <ion-navbar color="primary">\n    <button ion-button="" menuToggle="" (click)="onToggleMenu()">\n      <ion-icon name="menu"></ion-icon>\n    </button>\n    <ion-title>\n      Liste des CD\n    </ion-title>\n  </ion-navbar>\n</ion-header>\n\n<ion-content padding>\n  <p>Cette liste contient les cd et leurs Etats</p>\n  <button ion-item\n          icon-start\n          *ngFor="let Cd of CdList;\n          let i = index"\n          (click)="onLoadCd(i)">\n    <ion-icon name="disc" [color]="Cd.etat ? \'secondary\' : \'danger\' "></ion-icon>\n    {{Cd.title}}\n    <p *ngIf="Cd.namePersonne">{{Cd.namePersonne}}</p>\n  </button>\n</ion-content>\n'/*ion-inline-end:"C:\Users\admin\Desktop\bookCd-master\src\pages\cd\cd.html"*/
        }),
...
var HomePage = /** @class */ (function () {
    ...
    HomePage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-home',template:/*ion-inline-start:"C:\Users\admin\Desktop\bookCd-master\src\pages\home\home.html"*/'<ion-header>\n  <ion-navbar>\n    <ion-title>\n      Acceuil\n    </ion-title>\n  </ion-navbar>\n</ion-header>\n\n<ion-content padding>\n<ion-list>\n  <button ion-item\n          icon-start\n          *ngFor="let livres of LivresList;\n          let i = index"\n          (click)="onLoadLivre(i)">\n    <ion-icon name="bookmarks" color ="secondary"></ion-icon>\n    {{livres.title}}\n  </button>\n  <button ion-item\n          icon-start\n          *ngFor="let cd of cdList;let  i = index"\n          (click)="onLoadCd(i)">\n\n    <ion-icon name="disc" color="primary"></ion-icon>\n    {{cd.title}}\n  </button>\n</ion-list>\n</ion-content>\n'/*ion-inline-end:"C:\Users\admin\Desktop\bookCd-master\src\pages\home\home.html"*/
        }),
